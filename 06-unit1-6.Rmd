...
```{r mammal_dotplot, message=FALSE, echo=FALSE, warning=FALSE, include=TRUE, echo=FALSE}
library(tidyverse)
library(Lock5Data)

ggplot(MammalLongevity,aes(x=Longevity)) + 
  geom_dotplot(fill="#8eedf7", color="black",dotsize = 1.3) + 
